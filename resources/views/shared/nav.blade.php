<nav class="navbar navbar-default navbar-fixed-top" style="background-color:#354c70;">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('home')}}"><img src="{{asset('assets/img/logotext.png')}}" alt=""></a>
        </div>
            ...
            <ul class="nav navbar-nav navbar-right ">
                ...
                @else
                    ...
                    <li class="dropdown dropdown1 dropdown-mouse">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">{{$user->first_name}} </a>
